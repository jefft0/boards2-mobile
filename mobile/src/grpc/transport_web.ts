...
export function createWebTransport(options: ConnectTransportOptions): Transport {
  ...
  return {
        ...
        next: async (req: UnaryRequest<I, O>): Promise<UnaryResponse<I, O>> => {
          ...
          return {
            ...
            message: useBinaryFormat
              ...
              : fromJson(method.output, (await response.json()) as JsonValue, getJsonOptions(options.jsonOptions)),
    ...
    async stream<I extends DescMessage, O extends DescMessage>(
      ...
      async function createRequestBody(input: AsyncIterable<MessageShape<I>>): Promise<Uint8Array> {
