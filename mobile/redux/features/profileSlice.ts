...
export const followTxAndRedirectToSign = createAsyncThunk<void, { address: string; callerAddress: Uint8Array }, ThunkExtra>(
  'profile/follow',
  async ({ address, callerAddress }, thunkAPI) => {
...
export const unfollowTxAndRedirectToSign = createAsyncThunk<void, { address: string; callerAddress: Uint8Array }, ThunkExtra>(
  'profile/follow',
  async ({ address, callerAddress }, thunkAPI) => {
    console.log('Follow user: %s', address)
    const gnonative = thunkAPI.extra.gnonative
